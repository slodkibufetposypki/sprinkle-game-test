...
- **Sprinkle Wars prototype** (prototypes/wars/, online at https://slodkibufetposypki.github.io/sprinkle-game-test/prototypes/wars/)
  ...
  - Sprinkle mix art: 18 SVGs in prototypes/wars/assets/sprinkles/ (vermicelli, nonpareil, pearl, confetti × 4 colors; small pink heart; large white heart), recreated from the user's reference photo. Mix table (weights, sizes, tastiness) in js/sprinkle-mix.js; SVGs are pre-rendered to bitmaps at screen scale. Preview page: assets/sprinkles/preview.html.
